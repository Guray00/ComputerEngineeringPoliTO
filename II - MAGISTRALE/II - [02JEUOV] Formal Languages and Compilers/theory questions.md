...
## (GEN) What is the halting problem?

The halting problem is the problem of deciding, given a description of an arbitrary computer program and an input, whether the program finishes running or will run forever.
